...
class mnist_dataset(Data.Dataset):
    def __init__(self, train=True, transform=None, target_transform=None, noise_rate=0.5, split_per=0.9, random_seed=1, num_class=10):
        ...
        self.train_data = np.load('data/mnist/train_images.npy')
        self.train_labels = np.load('data/mnist/train_labels.npy')
        pass
...
class cifar10_dataset(Data.Dataset):
    def __init__(self, train=True, transform=None, target_transform=None, noise_rate=0.0, split_per=0.9, random_seed=1, num_class=10):
        ...
        self.train_data = np.load('data/cifar10/rm_40pc_train_images.npy')
        self.train_labels = np.load('data/cifar10/rm_40pc_train_labels.npy')
        #if self.train:      
        #    #self.train_data = self.train_data.reshape((45000,3,32,32))
        #    self.train_data = self.train_data.reshape((50000,3,32,32))
        #    self.train_data = self.train_data.transpose((0, 2, 3, 1)) 
        self.train_data = self.train_data.reshape((30000,3,32,32))
        self.train_data = self.train_data.transpose((0, 2, 3, 1)) 
